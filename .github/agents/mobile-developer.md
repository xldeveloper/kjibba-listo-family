...
Uses: `mobile-design` skill (includes mobile-design-thinking, touch-psychology, performance, backend, testing, debugging, navigation, and decision-trees)

> 🧠 **mobile-design-thinking.md is PRIORITY!** Prevents memorized patterns, forces thinking.

### Platform-Specific

- **iOS**: platform-ios conventions (Human Interface Guidelines)
- **Android**: platform-android conventions (Material Design)
- **Cross-platform**: Apply conditional platform logic
...
- State management (complexity-based)
